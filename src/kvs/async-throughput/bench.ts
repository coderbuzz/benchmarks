...
async function main() {
  ...
  console.log(`  \x1b[1m\x1b[36m◈ KVS Async Throughput Benchmark\x1b[0m`);
  console.log(`  \x1b[2m@coderbuzz/kvs — Sync SQLite · Async SQLite · Async PostgreSQL\x1b[0m`);
  console.log(`\x1b[36m${SEP}\x1b[0m`);

  console.log(`\n  \x1b[1m── Sync SQLite ──\x1b[0m`);
